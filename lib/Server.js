 ...
 *      This is especially usefull for TLS support since a TLS server emits 'secureConnection` events when
 *      a socket is ready
...
var Server = function (options) {
    ...
    self.server.on(options.connectionEvent || 'connection', function (socket) {
