...
Server.prototype._setupConnection = function (socket) {
    ...
    socket.parser.on('error', function (error) {
        self.logger.error('Connection #', socket.socketId, '(' + self.getAddress(socket) + ')', 'had a parse error, disconnecting.', error)
        socket.destroy()
    })
    ...
    socket.on('error', function (error) {
        self.logger.error('Connection #', socket.socketId, '(' + self.getAddress(socket) + ')', 'had an error:', error)
        socket.destroy()
    })
